...
| Painted water: the ripple simulation, the water surface and its shader, water depth and flow, how water is lit, refraction and reflections, the scene copy it is drawn from, wakes and splashes, the water fidelity setting | [docs/engine/water.md](docs/engine/water.md) — presentation only: stepped on the frame's clock, never read by a tick |
...
a layer of its own over the ground — depth, colour, opacity and flow per
cell — its ripples simulated on the frame's clock, going round props and
