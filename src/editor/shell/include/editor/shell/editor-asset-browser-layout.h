...
/// Divide @p panel into its header, folder pane, and card area.
///
/// A panel too narrow for the folder pane gives it whatever is there and
/// leaves the cards nothing, rather than handing either a negative width.
[[nodiscard]] EditorAssetBrowserLayout layoutAssetBrowser(const Rect& panel);
