...
/// What the section is called in the folder pane.
inline constexpr std::string_view EDITOR_GENERAL_FOLDER_NAME = "General";

/// Add the General section to @p tree as a second top-level folder, holding
/// every built-in item, and return its index.
///
...
/// directory's name would say it did.
///
