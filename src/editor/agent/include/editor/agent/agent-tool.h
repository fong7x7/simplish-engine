...
enum class AgentTool : uint8_t {
  ...
  LIST_SPRITES,
  /// The terrains the ground is painted with, and what is painted where.
  GET_GROUND,
  ...
  LIST_BEHAVIORS,
  /// Every enemy archetype the project defines, for the director to spawn.
  LIST_ENEMIES,
  ...
  ADD_SPRITE,
  /// Paint a rectangle of the ground with a terrain, as the Tile tool does.
  PAINT_GROUND,
  ...
  SET_SOUND,
  /// Every clip's and sheet's animation events, and where they came from.
  LIST_ANIMATION_EVENTS,
  /// Give a clip or a sprite sheet the sounds it makes as it plays.
