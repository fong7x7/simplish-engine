...
- [docs/editor/project-format.md](../../docs/editor/project-format.md) — the
  on-disk format. Seven kinds of file exist today: `.simplish/project.json`;
  ...
  footsteps (§8.4); and `content/data/animation-events.data.json`, the
  sounds clips and sprite sheets make as they play (§8.5). The editor reads
  the first three tables but never writes them; it writes the last two.
