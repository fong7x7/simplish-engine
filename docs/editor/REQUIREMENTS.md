...
| `src/editor/agent/` | The agent API: 21 tools over the shell's own state, the JSON protocol, and the binding to a running editor | Built; 56 tests |
