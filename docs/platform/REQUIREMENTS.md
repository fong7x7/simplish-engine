...
| DX12 backend | `src/platform/render/backends/dx12/` | 25 | Device, command list, handle table, descriptor heap allocator, frames-in-flight, resource wrappers, shared root signature, built-in GUI, static mesh, skinned mesh, outline, effects, volumetric-smoke and water pipelines |
