...
- **Cues for everything else** — bites, hazard pools landing, deaths, pickups. The cues there are already heard ([audio.md §9](audio.md#9-what-a-fight-sounds-like)); new ones will be too.
